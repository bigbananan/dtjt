          ...
          <table class="table table-hover table-bordered">
                ...
                @foreach ($singapuras as $singapura)
                 <?php
                    ...
                    $tiga = substr("$singapura->number",2,1);
                    $empat = substr("$singapura->number",3,1);
                    $shio = substr("$singapura->number",0,2);
          ...
          <table class="table table-hover table-bordered">
                ...
                @foreach ($singapuras as $singapura)
                 <?php
                    ...
                    $tiga = substr("$singapura->number",2,1);
                    $empat = substr("$singapura->number",3,1);
                    $satush = substr("$singapura->number",0,1) % 2;
                    $sh = 0;
                        if ($satush == $sh) {
                            $satush1 = "genap";
                        } else {
                    ...
                    $duash = substr("$singapura->number",1,1) % 2;
                    $hs = 0;
                        if ($duash == $hs) {
                            $duash1 = "genap";
                        } else {
          ...
          <table class="table table-hover table-bordered">
                ...
                @foreach ($singapuras as $singapura)
                 <?php
                    ...
                    $tiga = substr("$singapura->number",2,1);
                    $empat = substr("$singapura->number",3,1);
                    $tigash = substr("$singapura->number",1,1) % 2;
                    $sh = 0;
                        if ($tigash == $sh) {
                            $tigash1 = "genap";
                        } else {
                    ...
                    $empatsh = substr("$singapura->number",2,1) % 2;
                    $hs = 0;
                        if ($empatsh == $hs) {
                            $empatsh1 = "genap";
                        } else {
